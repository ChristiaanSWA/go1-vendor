    ...
    <div :class="['head-layout', { collapsed: isSidebarCollapsed }]">
        <div class="head-content">
            ...
            <div class="">
                ...
                <div class="">
                    <!-- <div class="flex gap-4 pt-5 px-5">
                        <div class="flex gap-4">
                            <div class="number-card-container border-2 rounded-lg p-5 h-[125px] w-[245px]">
                                <div class="card">
                                    <div class="card-body">
                            ...
                            <div class="number-card-container border-2 rounded-lg p-5 h-[125px] w-[245px]">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h2 v-if="pendingInvoice !== null"
                                            class="card-number font-semibold text-3xl pt-3">
                                            {{
                                                pendingInvoice }}</h2>
                                        <p v-else>Loading...</p>
                                    </div>
...
export default {
    ...
    setup() {
        ...
        //     labels: ['Pending', 'Received', 'Ordered'],
        //     datasets: [
        //         {
        //             label: 'Material Request Status',
        //             data: [0, 0, 0],
        //             backgroundColor: ['#abdadb', '#1976d2', '#f205af'],
        //             hoverBackgroundColor: ['#d32f2f', '#388e3c', '#1976d2'],
        //         },
        //     ],
        // });
...
// Bar Chart
        ...
        //     try {
        //         const response = await fetch('/api/method/go1_vendor.sales.get_purchase_count');
        //         const data = await response.json();

        //         if (data.message && typeof data.message.total_count === 'number') {
        //             purchaseCount.value = data.message.total_count;
        //         } else {
            ...
            try {
                ...
                if (data.message) {
                    ...
                    lineChartOptions.scales.y.ticks.callback = (value) => {
                        if (value === 0) return '0';
                        return yAxisUnit ? `${value / (yAxisUnit === 'Cr' ? 1e7 : 1e5)} ${yAxisUnit}` : value.toString();
                    };
        ...
        //     try {
        //         const response = await fetch('/api/method/go1_vendor.sales.get_status_counts');
        //         const data = await response.json();
